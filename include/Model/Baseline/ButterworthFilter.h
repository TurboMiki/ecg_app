...
#include <vector>
  ...
  public:
    ...
    static ButterworthFilter CreateLowPass(int order, float normalizedFreq)
    ...
    static ButterworthFilter CreateLowPass(int order, float freq, float sampleRate)
    ...
    static ButterworthFilter CreateHighPass(int order, float normalizedFreq)
    ...
    static ButterworthFilter CreateHighPass(int order, float freq, float sampleRate)
    ...
    static ButterworthFilter CreateBandPass(int order, float normalizedFreq1, float normalizedFreq2)
    ...
    static ButterworthFilter CreateBandPass(int order, float freq1, float freq2, float sampleRate)
    ...
    static ButterworthFilter CreateBandStop(int order, float normalizedFreq1, float normalizedFreq2)
    ...
    static ButterworthFilter CreateBandStop(int order, float freq1, float freq2, float sampleRate)
    ...
    void ProcessInPlace(std::vector<float> &samples)
      { for (auto &sample : samples) { sample = Process(sample); } }
  ...
  protected:
    ...
    static ButterworthFilter Create(int order, float normalizedFreq, FilterType type)
      { return Create(order, normalizedFreq, normalizedFreq, type); }

    static ButterworthFilter Create(int order, float normalizedFreq1, float normalizedFreq2, FilterType type)
    {
